...
export default function PropertyHandler() {
    ...
    const hit_propertyUpdation = (key, value, e) => {
        console.log(key)
        console.log(value)
        console.log(localStorage.getItem("nname_v2"))
        var nname = localStorage.getItem("nname_v2")
        ...
        //call special api - property update while creation itself
        axios
            .post('http://127.0.0.1:5000/nodepropcreate', { totalList })
            .then(result => {
                // console.log(result);
