...
export default function BasicRelationshipEditor() {
    ...
    const hit_relncreation = (e) => {
        ...
        localStorage.setItem("selected_nname1", n1)
        localStorage.setItem("selected_nname2", n2)
        var idsList = []
        var idsDict = {}
        var flag = 0
        ...
        localStorage.setItem("selected_rel_node1ID", idsDict['node1'])
        localStorage.setItem("selected_rel_node2ID", idsDict['node2'])
    ...
    const onNode2Select = (e) => {
        e.preventDefault();
        console.log(e.target.value)
        // localStorage.setItem("selected_nname2", document.getElementById('nodename-2').value)
    }
